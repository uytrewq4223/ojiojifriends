    ...
    <Layout>
      ...
      <div className="container mx-auto py-8 px-4">
        <section className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-semibold mb-6">おじおじフレンズ札幌店の理念</h2>
          <p className="mb-4 text-main">
            おじおじフレンズ札幌店は、心と体の癒しを追求する女性専用のプライベートエステサロンです。厳しい研修を修了した熟練のセラピストが、お客様一人一人に合わせた最適なトリートメントプランをご提案いたします。
          </p>
          <p className="mb-4 text-main">
