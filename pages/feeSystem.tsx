      ...
      <div className="container mx-auto py-8 ">
        ...
        <div className="space-y-12">
          <FeeSection
            ...
            items={[
              { name: "60分コース", description: "初見で緊張される方の為の初回限定デートコースです。※指名料込み", price: "5000円" }
            ]}
          />
          ...
          <FeeSection
            ...
            items={[
              { name: "90分コース", description: "アロマ＆性感マッサージのお試しコースです。", price: "15,000円" },
              { name: "120分コース", description: "初めてご利用のお客様におすすめのスタンダードコースです。", price: "20,000円" },
              { name: "150分コース", description: "リピーター様に大人気の特別ロングコースです。", price: "25,000円" },
              { name: "新人限定120分コース", description: "指名料込みで期待の新人をお試しいただけるコースです。", price: "10,000円" },
